...
public class Student {
 ...
 public Object name;
    ...
    //private: It can be used just inside the "Student" class.
 //It can be used just inside the class it was created
 private String stdId = "TH202217007";

 //default: It can be used just inside the "day20accessmodifiersinheritance" package
 //It can be used just inside the package it was created
 //It is called also "package private".
 double stdGpa = 3.83;//If you do not type any access modifier it will be "default"

 //protected:It can be used inside the package it was created,and from the child classes in other packages
